...
export default function Home() {
  return (
    <main className="relative min-h-screen overflow-x-hidden yoruba-pattern px-2 py-3 text-text-dark sm:px-5 sm:py-8">
      ...
      <div className="relative mx-auto flex min-h-[calc(100vh-1.5rem)] w-full max-w-6xl items-start justify-center sm:items-center">
        <Calculator />
      </div>
    </main>
  );
