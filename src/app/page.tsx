...
export default function Home() {
  return (
    <main className="relative min-h-screen overflow-x-hidden yoruba-pattern px-0 py-0 text-text-dark sm:px-5 sm:py-8">
      ...
      <div className="relative mx-auto flex min-h-screen w-full max-w-6xl items-start justify-center sm:min-h-[calc(100vh-4rem)] sm:items-center">
        <Calculator />
      </div>
    </main>
  );
