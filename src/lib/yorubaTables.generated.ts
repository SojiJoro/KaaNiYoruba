...
export const TRADITIONAL_0_99: Record<number, string> = {
  0: 'Òdo',
  1: 'Ọ̀kan',
  2: 'Méjì',
  3: 'Mẹ́ta',
...
export const SCALE_WORDS_BIG: Array<{ value: bigint; word: string }> = [
  { value: 10n ** 33n, word: 'Dẹ́sílíọ̀nù' },
  { value: 10n ** 30n, word: 'Nónílíọ̀nù' },
  { value: 10n ** 27n, word: 'Ọ́kítílíọ̀nù' },
  { value: 10n ** 24n, word: 'Sẹ́ptílíọ̀nù' },
  { value: 10n ** 21n, word: 'Sẹ́kítílíọ̀nù' },
  { value: 10n ** 18n, word: 'Kwíntílíọ̀nù' },
  { value: 10n ** 15n, word: 'Kwadírílíọ̀nù' },
  { value: 10n ** 12n, word: 'Tirílíọ̀nù' },
  { value: 10n ** 9n, word: 'Bílíọ̀nù' },
  { value: 10n ** 6n, word: 'Mílíọ̀nù' },
  { value: 10n ** 3n, word: 'Ẹgbẹ̀rún' },
];

export const CLASSICAL_EXACT: Record<number, string> = {
  2000: 'Ẹgbàá',
  4000: 'Ẹgbàájì',
};

export const OKE = { value: 20000n, word: 'Ọkẹ́' } as const;

export const ORDINALS_1_10: Record<number, string> = {
  1: 'Àkọ́kọ́',
  2: 'Ìkejì',
  3: 'Ìkẹta',
  4: 'Ìkẹrin',
